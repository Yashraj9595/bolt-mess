  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        "primary-blue": "bg-primary-blue text-white hover:bg-primary-blue/90",
        "secondary-blue": "bg-secondary-blue text-white hover:bg-secondary-blue/90",
        "dark-blue": "bg-dark-blue text-white hover:bg-dark-blue/90",
        "neutral": "bg-neutral-gray text-dark-blue hover:bg-neutral-gray/80",
        "outline-blue": "border border-primary-blue text-primary-blue bg-transparent hover:bg-primary-blue/10",
